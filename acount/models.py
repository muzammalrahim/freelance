...
class Profile(models.Model):
	...
	verification_status = models.CharField(choices=VERIFICATION_STATUS_CHOICES, max_length=10)
	...
	experience_level = models.CharField(choices=EXPERIENCE_LEVEL_CHOICES, max_length=12)
