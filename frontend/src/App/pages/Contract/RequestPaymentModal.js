                ...
                <DialogContentText>
                  ...
                  <div className="cont-submit-payment pb-4">
                      ...
                      <h3 className="pb-1">Upload Files</h3>
                          <GetImage
                          idVerf_DL_imgUpload={uploadFile} value="idVerf_DL_imgUpload"/>
                      </div>
                          <div className="bid-buttons d-flex justify-content-center pb-4 mt-5">
                            ...
                            <button onClick={handleSubmit} class="btn btn--yellow btn--medium" autoFocus> Submit</button>
                          </div>
                  </div>
                  </div>
                </DialogContentText>
