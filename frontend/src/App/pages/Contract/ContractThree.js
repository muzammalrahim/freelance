                                                ...
                                                <div className="container">
                                                    <div className="row mb-3">
                                                        ...
                                                        <div className="state-active1 pr-3">
                                                            <li><span className="active-state mr-1"></span>Completed</li>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="row m-info r-3 pl-3 mt-4 pb-2">
                                                        ...
                                                        <div className="col-md-5 pr-0">
                                                            <div className="mile-payment-status">
                                                                {/* <a href="#"><p><span className="tick-status pr-1"><CheckCircleIcon/></span>Payment Recieved</p></a> */}
                                                                <FeedBackModal/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="container">
                                                    <div className="row mb-3">
                                                        ...
                                                        <div className="state-disable pr-3">
                                                            <li><span className="disable-state mr-1"></span>Inactive</li>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    <div className="row m-info pl-2">
                                                        ...
                                                        <div className="col-md-9 align-self-center pt-2 pl-0">
                                                            <div>
                                                            <h4 className="align-self-center"><b>Prototype</b></h4>
                                                            </div>
                                                        </div>
                                                        <div className="col-md-2 pr-0 pt-1">
                                                        <div>
                                                    ...
                                                    <div className="row m-info r-3 pl-3 mt-4 pb-2">
                                                        ...
                                                        <div className="col-md-5 pr-0">
                                                            {/* <div className="mile-inner-text">
                                                                <p className="mile-heading">Payment Request Submitted<br></br>
