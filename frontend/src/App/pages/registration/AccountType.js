      ...
      return (
        <div className="main back_g">
          <div className="AccountType">
            <div className="container-fluid AccountType_container">
              <div className="row">
                <div className="col-sm-3  col-md-3 back_gr sidebarcolheight">
                  <div className="p-2">
                    <img
                      className="accounttype_logo"
                      src={AccountTypelogo}
                      alt="Logo"
                    ></img>
                  </div>
                  ...
                  <div className="sidebarMiddleContent p-1">
                    <p className="para_style1">
                      It is a long established fact that a reader will be
                      distracted by the readable layout
                    </p>
                    <p className="para_style2">
                      Creating your account in just a few steps away, Select
                      your account detail type.
                    </p>
                  </div>
                  ...
                  <div className="container">
                    <div className="w-100">
                      ...
                      <p className="rightPara">
                        Creating your account in just a few steps away,
                        <br />
                        Select your account detail type.
                      </p>
                    </div>
